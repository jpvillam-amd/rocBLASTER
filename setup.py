...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        subprocess.run(["cmake", "-D GPU_TARGETS=native", "-D CMAKE_CXX_COMPILER:PATH=/opt/rocm/bin/amdclang++", "-D CMAKE_PREFIX_PATH=/opt/rocm", ext.sourcedir], cwd=build_temp, check=True, env=env)
